...
Currently, my projects consist of testing online implementations of my random forest and neural network emulators, as well as assessing the dynamical properties of data-driven weather prection models. The coupling project is an extension of the work in our recent maniscript (Limon & Jablonowski, 2023) and has required a significant amount of troubleshooting both from a hardward and software standpoint. Dynamical tests for data driven weather models include attempting to produce a simple baroclinic wave above the southern ocean within Google's GraphCast weatehr prediction model. This test case is currently in development and is intended to be incorporated into the upcoming DCMIP 2025 meeting in Boulder.
